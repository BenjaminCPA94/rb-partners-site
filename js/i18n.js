...
const RB_TRANSLATIONS = {
  fr: {
    ...
    'fe.eyebrow': 'Notre offre',
    'fe.title': 'Facturation électronique : passez à la réforme sereinement',
    'fe.lead': "La facturation électronique devient progressivement obligatoire pour toutes les entreprises assujetties à la TVA en France. RB Partners vous accompagne à chaque étape pour que cette transition ne perturbe ni votre facturation, ni votre trésorerie.",
    'fe.intro1': "Choix de la plateforme de dématérialisation, compatibilité de vos outils, formation de vos équipes, archivage probant&nbsp;: la mise en conformité soulève de nombreuses questions techniques pour une entreprise qui n'a pas vocation à devenir experte en facturation électronique. C'est précisément le rôle que nous jouons à vos côtés.",
    'fe.intro2': "Nous commençons par un diagnostic de vos flux de facturation actuels (émission, réception, volumes, outils en place) pour identifier la solution la mieux adaptée à votre activité, avant de vous accompagner dans son déploiement.",
    'fe.intro3': "Cette offre s'adresse aussi bien aux entreprises qui souhaitent anticiper la réforme dès maintenant qu'à celles qui doivent encore choisir leur plateforme et sécuriser leur passage à l'échéance qui les concerne.",
    'fe.services_title': 'Ce que comprend notre accompagnement',
    'fe.services.0': "Diagnostic de vos flux de facturation actuels (émission, réception, volumes, outils)",
    'fe.services.1': "Aide au choix d'une plateforme de dématérialisation partenaire (PDP) adaptée à votre volume",
    'fe.services.2': "Vérification de la compatibilité de votre logiciel de facturation ou de comptabilité",
    'fe.services.3': "Formation de vos équipes aux nouveaux flux d'émission et de réception",
    'fe.services.4': "Mise en place de l'archivage électronique probant de vos factures",
    'fe.services.5': "Suivi de votre dossier jusqu'à l'échéance qui vous concerne, avec ajustement si le calendrier légal évolue",
    'fe.calendar_title': 'Un calendrier encore mouvant',
    'fe.calendar_text': "Les dates exactes de la réforme ont déjà été ajustées plusieurs fois par le législateur et le déploiement est progressif selon la taille des entreprises. Plutôt que de vous fier à une date isolée trouvée en ligne, parlons ensemble de l'échéance qui s'applique précisément à votre structure.",
    'fe.cta_title': 'Prêt à sécuriser votre passage à la facturation électronique ?',
    'fe.cta_text': "Parlons de vos outils actuels et du calendrier qui s'applique à votre entreprise.",
    'fe.read_article': 'Lire notre article sur la réforme',
  },
  ...
  en: {
    ...
    'fe.eyebrow': 'Our offer',
    'fe.title': 'E-invoicing: navigate the reform with confidence',
    'fe.lead': "E-invoicing is becoming mandatory, step by step, for every VAT-registered business in France. RB Partners supports you at every stage so this transition disrupts neither your invoicing nor your cash flow.",
    'fe.intro1': "Choosing a compliant platform, checking tool compatibility, training your teams, setting up legally compliant archiving&nbsp;: compliance raises many technical questions for a business that isn't meant to become an e-invoicing expert. That's exactly the role we play alongside you.",
    'fe.intro2': "We start with a diagnostic of your current invoicing flows (issuing, receiving, volumes, tools in place) to identify the solution best suited to your business, before supporting you through its rollout.",
    'fe.intro3': "This offer suits both businesses that want to get ahead of the reform now and those that still need to choose their platform and secure their transition ahead of their specific deadline.",
    'fe.services_title': 'What our support includes',
    'fe.services.0': 'Diagnostic of your current invoicing flows (issuing, receiving, volumes, tools)',
    'fe.services.1': 'Help choosing an accredited e-invoicing platform (PDP) suited to your volume',
    'fe.services.2': 'Checking the compatibility of your invoicing or accounting software',
    'fe.services.3': 'Training your teams on the new issuing and receiving workflows',
    'fe.services.4': 'Setting up legally compliant electronic archiving for your invoices',
    'fe.services.5': 'Follow-up on your file through to your specific deadline, adjusted if the legal timeline changes',
    'fe.calendar_title': 'A timeline still in motion',
    'fe.calendar_text': "The exact reform dates have already been adjusted several times by lawmakers, and the rollout is staggered by company size. Rather than relying on a single date found online, let's talk about the deadline that applies specifically to your business.",
    'fe.cta_title': 'Ready to secure your move to e-invoicing?',
    'fe.cta_text': "Let's talk about your current tools and the timeline that applies to your business.",
    'fe.read_article': 'Read our article on the reform',
  },
};
