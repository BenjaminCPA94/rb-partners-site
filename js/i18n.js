...
const RB_TRANSLATIONS = {
  fr: {
    ...
    'expertises.cta_title': "Une question sur l'une de nos expertises ?",
    'expertises.cta_text': "Parlons de votre activité et du niveau d'accompagnement dont vous avez besoin.",
    ...
    'accompagnement.intro1': "Chaque entreprise traverse des phases différentes, et chacune appelle un niveau d'accompagnement différent. Notre rôle est de rester le même interlocuteur tout au long de ce parcours, pour que vous n'ayez jamais à réexpliquer votre activité à quelqu'un de nouveau.",
    'accompagnement.intro2': "Au démarrage, nous vous aidons à poser les bonnes bases&nbsp;: structure juridique, outils de gestion, prévisionnel financier. Une fois l'activité lancée, nous devenons votre partenaire de pilotage au quotidien&nbsp;: comptabilité, paie, fiscalité, tableaux de bord.",
    'accompagnement.intro3': "Et lorsque votre entreprise grandit, nous vous accompagnons dans les décisions structurantes&nbsp;: recrutement, levée de fonds, structuration en groupe. Le même cabinet, à chaque étape.",
    'accompagnement.list_title': 'Notre accompagnement',
    'accompagnement.services_title': 'Les expertises mobilisées',
    'accompagnement.services_text': "Selon l'étape où vous en êtes, cet accompagnement s'appuie sur nos différentes expertises&nbsp;:",
    'accompagnement.cta_title': 'Vous lancez ou développez votre entreprise en France ?',
    'accompagnement.cta_text': 'Parlons de l’étape où vous en êtes et de vos prochains objectifs.',
    ...
    'international.intro1': "S'implanter dans un pays dont vous ne maîtrisez pas toujours les codes juridiques, fiscaux et sociaux est un exercice délicat. Notre rôle est de vous éviter les mauvaises surprises, en vous donnant une visibilité claire sur chaque étape avant de vous y engager.",
    'international.intro2': "Nous commençons toujours par la question la plus structurante&nbsp;: quelle forme d'implantation correspond à votre projet&nbsp;? Filiale, succursale et bureau de liaison n'ont ni la même fiscalité, ni les mêmes obligations, ni le même niveau de responsabilité pour votre société mère.",
    'international.intro3': "Une fois la structure choisie et immatriculée, nous restons votre interlocuteur unique pour la gestion sociale, la fiscalité locale et la coordination avec vos équipes et conseils à l'étranger — en français comme en anglais.",
    'international.services_title': 'Les expertises mobilisées',
    'international.services_text': "Votre implantation s'appuie sur nos expertises les plus directement liées à ce projet&nbsp;:",
    'international.cta_title': "Un projet d'implantation en France ?",
    'international.cta_text': 'Parlons de votre société d’origine et de votre calendrier.',
    ...
    'form.error': "Une erreur est survenue. Vous pouvez nous écrire directement à contact@rb-partners.fr.",
  ...
  en: {
    ...
    'expertises.cta_title': 'A question about one of our services?',
    'expertises.cta_text': "Let's talk about your business and the level of support you need.",
    ...
    'accompagnement.intro1': "Every business goes through different phases, and each one calls for a different level of support. Our role is to stay the same point of contact throughout, so you never have to re-explain your business to someone new.",
    'accompagnement.intro2': "At launch, we help you set the right foundations&nbsp;: legal structure, management tools, financial forecast. Once the business is up and running, we become your day-to-day steering partner&nbsp;: accounting, payroll, tax, dashboards.",
    'accompagnement.intro3': "And as your business grows, we support you through the decisions that matter&nbsp;: hiring, fundraising, structuring into a group. The same firm, at every stage.",
    'accompagnement.list_title': 'Our support',
    'accompagnement.services_title': 'The expertise areas involved',
    'accompagnement.services_text': 'Depending on where you are, this support draws on our different areas of expertise&nbsp;:',
    'accompagnement.cta_title': 'Launching or growing your business in France?',
    'accompagnement.cta_text': "Let's talk about where you are and what's next.",
    ...
    'international.intro1': "Setting up in a country whose legal, tax and social rules you don't always master is a delicate exercise. Our role is to spare you unpleasant surprises, by giving you clear visibility on each step before you commit to it.",
    'international.intro2': "We always start with the most structural question&nbsp;: which setup structure fits your project? Subsidiary, branch and liaison office each carry different taxation, different obligations and a different level of liability for your parent company.",
    'international.intro3': "Once the structure is chosen and registered, we remain your single point of contact for social compliance, local taxation and coordination with your teams and advisors abroad — in both French and English.",
    'international.services_title': 'The expertise areas involved',
    'international.services_text': 'Your setup draws on the expertise areas most directly linked to this project&nbsp;:',
    'international.cta_title': 'Planning a setup in France?',
    'international.cta_text': "Let's talk about your parent company and your timeline.",
    ...
    'form.error': 'Something went wrong. You can email us directly at contact@rb-partners.fr.',
