...
const RB_TRANSLATIONS = {
  fr: {
    ...
    'sim.dividendes.excerpt': "Comparez la fiscalité de vos dividendes entre prélèvement forfaitaire unique (30 %) et option pour le barème progressif de l'impôt sur le revenu.",
    ...
    'sim.dividendes.pfu_label': 'Prélèvement forfaitaire unique (30 %)',
    ...
    'sim.dividendes.ps_label': 'Prélèvements sociaux (17,2 %)',
  ...
  en: {
    ...
    'sim.dividendes.excerpt': "Compare the taxation of your dividends between the flat tax (30%) and the option for France's progressive income tax scale.",
